...
class SqueezeNet(chainer.Chain):
    def __init__(self, ):
        super(SqueezeNet, self).__init__(
            ...
            conv10=L.Convolution2D(512, 2, 1,
                pad=1, initialW=ran.normal(0, 0.01 ,(2, 512, 1, 1)))
        )
    ...
    def __call__(self, x, train=False):
        ...
        #print("output of last convLayer: {}".format(h.shape))
        h = F.average_pooling_2d(h, 16)

        return F.reshape(h, (-1, 2))
